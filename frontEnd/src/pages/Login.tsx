        ...
        <>
            <div className="min-h-screen flex items-center justify-center bg-transparent px-4">
                <div className="bg-white max-w-4xl w-full rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
                    <div className="hidden md:flex flex-col justify-center items-center bg-amber-600 text-white p-10 w-1/2 text-center">
                    ...
                    <div className="flex flex-col justify-center items-center p-10 w-full md:w-1/2 bg-zinc-800 text-center">
